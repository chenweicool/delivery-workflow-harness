const WORKFLOW_UNITS = [
  ...
  },
  {
    ...
    inputs: ['design/requirement-confirmation.approved.json', '已确认应用代码', '任务编号'],
  ...
  },
  {
    ...
    outputs: ['review/ai-review.md', 'review/risk-list.md', 'review/unit-test-result.md', 'review/traceability-matrix.md', 'review/smoke-test-result.md'],
...
const STEP_DEFINITIONS = {
  ...
  'manual-technical': {
    ...
    inputs: ['design/technical-design.md', 'design/unit-test-design.md', 'design/smoke-test-design.md', 'design/technical-confirmation.md', 'design/technical-review.md'],
    reviewFiles: [
  ...
  '08-verify-tests': {
    ...
    outputs: ['review/unit-test-result.md', 'review/traceability-matrix.md'],
  },
  '09-run-smoke': {
    title: '09 冒烟验证',
    kind: 'agent',
    commandFile: '.workflow/commands/09-run-smoke.md',
    outputs: ['review/smoke-test-result.md'],
  },
